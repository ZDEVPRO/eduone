...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=351, verbose_name='Sarlavhasi')),
                ...
                ('obshi_description', models.TextField(blank=True, max_length=3000, verbose_name='Hamma Tekst')),
            ...
            options={
                'verbose_name': 'Koledj yangiliklari',
                'verbose_name_plural': 'Koledj yangiliklari',
            },
        ),
        migrations.CreateModel(
            name='Newsindex',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=350, verbose_name='Sarlavhasi')),
                ('slug', models.SlugField(blank=True, max_length=200, null=True)),
                ('description', models.TextField(max_length=2000, verbose_name='Tavsifi')),
                ('past_description', models.TextField(blank=True, max_length=1000, verbose_name='Pastki Tavsif:')),
                ('obshi_description', models.TextField(blank=True, max_length=3000, verbose_name='Hamma Tekst')),
            ...
            options={
                'verbose_name': 'Yangiliklar (Asosiy menyu)',
                'verbose_name_plural': 'Yangiliklar (Asosiy menyu)',
            },
        ),
        migrations.CreateModel(
            name='Teacher',
